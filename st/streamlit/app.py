...
with st.form('Authorisation1'):
    with col1:
        aut1=st.text_input('ITkdb Authentication Code 1:',type="password")
    
    with col2:
        aut2=st.text_input('ITkdb Authentication Code 2:',type="password")
    ...
    if st.session_state.stage > 1:
        ...
        #charts=[]
            st.write('Making graph for institute '+str(selected_locations[i]))
